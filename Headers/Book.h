...
public:
     ...
     * 
     * Mutators / set functions: Come per le get functions, scriviamo set<var name>
     * 
 ...
 * 
 * NOTA: abbiamo deciso di sfruttare al meglio le get functions della classe
 ...
 *       non solo gli isbn ma, eventualmente, anche tutti gli altri parametri dei libri
 */
